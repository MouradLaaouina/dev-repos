...
$sql .= "SELECT o.* ";
// llx_user
$sql .= ', u.dateemployment, u.job, u.login, u.lastname, u.firstname, GROUP_CONCAT(COALESCE(u.firstname, ""), " ", COALESCE(u.lastname, "")) as full_name, u.email as user_email, u.statut as user_status, u.entity as user_entity, u.photo, u.office_phone, u.office_fax, u.user_mobile, u.job, u.gender';
