/*
  # Add code_client to call_center_leads

  1. New Columns
    - `code_client` (text) - Unique client code for ATLAS integration
  
  2. Indexes
    - Added index on `code_client` for better performance
  
  3. Documentation
    - Added comment explaining the purpose of the column
*/
